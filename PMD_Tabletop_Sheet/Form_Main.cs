...
namespace PMD_Tabletop_Sheet
{
    ...
    public partial class Form_Main : Form
    {
        ...
        private string loadonstartuppath;
        ...
        {
            InitializeComponent();
            dbpath = System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location);
            dbpath += "\\Stat_References.db";
            frm_dmgcalc.dbpath = dbpath;
            if (args.Length > 0)
            {
                loadonstartuppath = args[0];
            }
        }
        ...
        private void Form_Main_Load(object sender, EventArgs e)
        {
            ...
            // If we're loading from file, load from that file
            if (!String.IsNullOrWhiteSpace(loadonstartuppath))
            {
                Savefilepath = loadonstartuppath;
