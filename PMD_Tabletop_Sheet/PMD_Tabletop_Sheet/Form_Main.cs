...
namespace PMD_Tabletop_Sheet
{
    ...
    public partial class Form_Main : Form
    {
        ...
        private void Form_Main_Load(object sender, EventArgs e)
        {
            ...
            chk_move_selected_template.Location = new System.Drawing.Point(28, 4);
        ...
        private void loadLearnsetFromSpecies(string species)
        {
            ...
            using (SQLiteConnection cn = new SQLiteConnection("Data Source=" + dbpath + ";Version=3;New=True;Compress=True;"))
            {
                ...
                SQLiteDataReader sqlite_datareader;
                sqlite_cmd = cn.CreateCommand();
                sqlite_cmd.CommandText = "Select Learnset.Move, Learnset.Obtained_By, Learnset.LV, Moves.Type, Moves.PP from Learnset join Moves on Moves.Name = Learnset.Move Where Learnset.Species = '" + txt_sht_species.Text + "' order by Learnset.Obtained_By, Learnset.LV, Learnset.Move";
                sqlite_datareader = sqlite_cmd.ExecuteReader();
                while (sqlite_datareader.Read())
                {
